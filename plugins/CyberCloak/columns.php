...
return [
    [
        ...
        'type'        => 'textarea',
        'required'    => false,
        'description' => 'JSON 数组。推荐使用 AccessKeyService 创建的 hash 记录，也兼容临时配置明文 key。',
        'rules'       => 'nullable|json',
    ],
    [
        'name'        => 'ip_whitelist',
    ...
    [
        ...
        'required'    => false,
        'description' => '仅对无有效 key/Cookie 的流量生效；不匹配或未识别的国家/地区会增加风险分。',
        'rules'       => 'nullable|array',
    ],
    [
        'name'        => 'traffic_blocked_countries',
        'label'       => '漏斗阻断国家/地区',
        'type'        => 'select-multiple',
        'options'     => $countryOptions,
        'required'    => false,
        'description' => '命中后进入挑战分支；GeoLite 无法识别时保持 unknown。',
        'rules'       => 'nullable|array',
    ],
    [
    ...
    [
        'name'        => 'ip_provider_enabled',
        'label'       => '启用 IP 黑名单供应商同步',
        'type'        => 'select',
        'options'     => [
            ['value' => '1', 'label' => '启用'],
            ['value' => '0', 'label' => '关闭'],
        ...
        'required'    => true,
        'description' => '前台只读取本地缓存，不会在请求中直接访问供应商。',
    ...
    [
        ...
        'type'        => 'select',
        'options'     => [
            ['value' => 'http', 'label' => 'HTTP JSON/文本'],
        ],
        'required'    => true,
        'rules'       => 'required|string|max:64',
    ],
    [
        'name'        => 'ip_provider_endpoint',
        'label'       => 'IP 供应商地址',
        'type'        => 'string',
        'required'    => false,
        'description' => '供应商返回 IPv4、IPv6 或 CIDR 的 JSON/文本地址。',
        'rules'       => 'nullable|url|max:2048',
    ],
    [
        'name'        => 'ip_provider_token',
        'label'       => 'IP 供应商 Token',
        'type'        => 'string',
        'required'    => false,
        'description' => 'Token 只用于请求头，不会写入同步日志。',
        'rules'       => 'nullable|string|max:2048',
    ],
    [
        'name'        => 'ip_provider_timeout',
        'label'       => 'IP 供应商超时秒数',
        'type'        => 'string',
        'required'    => true,
    ...
    [
        'name'        => 'ip_provider_fail_mode',
        'label'       => '供应商失败策略',
        'type'        => 'select',
        'options'     => [
            ['value' => 'public', 'label' => '失败时进入展示模式'],
            ['value' => 'keep', 'label' => '失败时保留现有规则'],
        ],
        'required'    => true,
        'rules'       => 'required|in:public,keep',
    ],
    [
        'name'        => 'ip_provider_allow_empty',
        'label'       => '允许供应商返回空列表',
        'type'        => 'select',
        'options'     => [
            ['value' => '0', 'label' => '否'],
    ...
    [
        'name'        => 'ip_provider_schedule',
        'label'       => '同步周期',
        'type'        => 'select',
        'options'     => [
            ['value' => 'every_15_minutes', 'label' => '每 15 分钟'],
            ['value' => 'hourly', 'label' => '每小时'],
            ['value' => 'every_6_hours', 'label' => '每 6 小时'],
            ['value' => 'daily', 'label' => '每天'],
        ],
        'required'    => true,
        'rules'       => 'required|in:every_15_minutes,hourly,every_6_hours,daily',
    ],
];
