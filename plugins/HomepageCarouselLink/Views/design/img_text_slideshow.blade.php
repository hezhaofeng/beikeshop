...
<section class="module-item {{ $design ? 'module-item-design' : ''}}" id="module-{{ $module_id }}">
  ...
  <script>
    var homepageCarouselImgTextSwiper_{{ $module_id }} = new Swiper ('.module-swiper-img-text-{{ $module_id }}', {
      loop: true,
      parallax: true,
    ...
    $('.module-img-text-slideshow').hover(function() {
      homepageCarouselImgTextSwiper_{{ $module_id }}.autoplay.pause();
    }, function() {
      homepageCarouselImgTextSwiper_{{ $module_id }}.autoplay.resume();
    });

    $(function () {
      homepageCarouselScrollText_{{ $module_id }}()

      function homepageCarouselScrollText_{{ $module_id }}() {
